...
#define UDP_PORT "22164" // this server's UDP port
...
int main(void)
{
    ...
    cout << "The Server B is up and running using UDP on port <" << UDP_PORT << ">." << endl;
    ...
    while(1) {
        ...
        cout << "The Server B has found <" << m << "> matches" << endl;
